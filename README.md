...
```javascript
import hasClassSupport from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-class-support@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-has-class-support/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-has-class-support/actions/workflows/test.yml?query=branch:v0.2.0
